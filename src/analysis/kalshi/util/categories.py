...
SUBCATEGORY_PATTERNS = [
    ...
    ("LOWNY", "Weather", "Low Temp", "New York"),
    ("LOWCHI", "Weather", "Low Temp", "Chicago"),
    ("LOWAUS", "Weather", "Low Temp", "Austin"),
    ("LOWMIA", "Weather", "Low Temp", "Miami"),
    ("LOWLAX", "Weather", "Low Temp", "Los Angeles"),
    ("LOWDEN", "Weather", "Low Temp", "Denver"),
    ("LOWPHIL", "Weather", "Low Temp", "Philadelphia"),
    ("LOWHOU", "Weather", "Low Temp", "Houston"),
    ("LOW", "Weather", "Low Temp", "Other"),
    ("LMONTH", "Weather", "Low Temp", "Monthly"),
